...
كل **اثنين عند منتصف الليل** (بداية كل أسبوع في اللعبة)، يتحقق المحرك مما إذا كان مصمم المستوى قد حدد **هدية أسبوعية** لذلك الأسبوع. إذا وُجدت، يتلقى روبوتك ذلك المورد عبر `OnWeeklyGiftReceived`. إذا لم تُحدد هدية لذلك الأسبوع، لا يُمنح أي شيء.
...
يحمل كل قطار **6 ركاب** افتراضياً (قابل للتعديل حسب المستوى).
...
| `OnWeeklyGift(snapshot, gift)` | اثنين منتصف الليل (فقط إذا وُجدت هدية محددة) | — |
...
- **استخدم الهدايا فوراً** — عند استلام مورد عبر `OnWeeklyGiftReceived`، حاول نشره في نفس الدورة.
