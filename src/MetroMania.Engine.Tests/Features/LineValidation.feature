Feature: Line Validation
  Verifies that the engine correctly rejects invalid CreateLine and ExtendLineFromTerminal
  player actions with the appropriate error codes, and that rejected actions leave the
